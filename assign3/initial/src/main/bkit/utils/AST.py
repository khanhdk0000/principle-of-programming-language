...
@dataclass
class FloatLiteral(Literal):  # yes
    value: float
...
@dataclass
class StringLiteral(Literal):  # yes
    value: str
...
@dataclass
class BooleanLiteral(Literal):  # yes
    value: bool
...
@dataclass
class ArrayLiteral(Literal):  # yes
    value: List[Literal]
